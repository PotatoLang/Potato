...
public class NestedGroupedAtBothSidesOfHigherPrec : TestBase
{
    public NestedGroupedAtBothSidesOfHigherPrec(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
    {
    }
